<%-- 
    ...
    Created on : 18 avr. 2019, 09:38:48
...
<c:if test="${source != null}">
    ...
    <c:set var="id" value="&id=${source.getId()}"></c:set>
</c:if>
<c:if test="${source == null}">
     ...
     aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-body">
                <form method="post" action="administration?q=${q}&action=model&model=sourceMouvement&isNew=${isnew}${id}" class="" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="${source.getNom()}"  class="form-control-sm round form-control" required id="firstName" name="nom">
                                </div>
                            </div>
                        </div>
                    </fieldset>
