<%-- 
    ...
    Created on : 26 nov. 2018, 17:51:52
            ...
            <div class="modal-body">
                <c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien106 or sessionScope.client != null}">
                    <button  class="btn t btn-outline-dark btn-sm round pull-right" 
                             ...
                             onclick="getDataToPrintCommande(${commande.get(0).getLigne().getId()}, 'A4')"><i class="fa fa-print"></i></button>
                    <button  class="btn t btn-outline-primary btn-sm round pull-right" 
                             ...
                             onclick="getDataToPrintCommande(${commande.get(0).getLigne().getId()}, 'A5')"><i class="fa fa-print"></i></button>
                    </c:if>
                <form method="post" action="administration?q=${q}&action=model&model=secteur&isNew=${isnew}${id}" class="" novalidate>
                    ...
                    <fieldset>
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                ...
                                                <span class="badge bg-blue-grey">
                                                    <f:formatNumber value="${commande.get(0).getLigne().getPrixtotal()}"type="CURRENCY" currencySymbol=" FCFA"/>  
                                                </span>

                                            </p>
                                            <c:if test="${commande.get(0).getLigne().getTransport() != null}">
                                                <p class="card-text">
                                                    <strong for="firstName">Transport : </strong>
                                                    <span class="badge bg-blue-grey">
                                                        <f:formatNumber value="${commande.get(0).getLigne().getTransport()}"type="CURRENCY" currencySymbol=" FCFA"/>  
                                                    </span>
                                                ...
                                                <table style="width: 100%"  class="table table-dark table-striped table-bordered ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach items="${commande}" var="cmd">
                                                            <c:set var="rem" value="${rem + cmd.getRemise()}"></c:set>
                        ...
                        <c:if test="${not empty commande.get(0).getLigne().getCommandeEmballageList()}">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 border-success">
                                    <div class="card ">
                                        <div class="card-content">
                                            <div class="card-body responsive">
                                                <h4 class="card-title info">Emballages</h4>
                                                ...
                                                <div style="overflow-x: scroll;">
                                                    <table style="width: 100%"  class="table table-dark table-striped table-bordered ">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:set var="pt" value="0"></c:set>
                                                            <c:set var="pp" value="0"></c:set>
                                                            <c:forEach items="${commande.get(0).getLigne().getCommandeEmballageList()}" var="cmd">
                                                                <c:set var="total" value="${total + cmd.getQuantite()}"></c:set>
                                                                <c:set var="pt" value="${pt + cmd.getPrixTotal()}"></c:set>
                                                                <c:set var="pp" value="${pp + cmd.getQt()}"></c:set>
                                                                    <tr>
