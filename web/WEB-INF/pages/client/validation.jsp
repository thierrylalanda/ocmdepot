                ...
                <div class="card-content">
                    ...
                    <ul class="list-group list-group-flush" style="max-height: 600px;overflow-y: scroll">
                        <c:forEach items="${commandesclients}" var="all">
                            <c:if test="${all.getEtatc().getCode()==502 and all.getClient().getId()==sessionScope.client.getId()}">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <c:if test="${commande!=null}">
                                <form class="form" novalidate method="post" action="gestionCommandes?action=model&model=PasserCommandes&q=${q}&isNew=2&id=${commande.getLigne().getNumc()}&ismodif=ok&idC=${commande.getId()}">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-3 col-sm-12">
                                                <label for="description">Commentaire</label>
                                                <textarea id="description" disabled class="form-control-sm form-control round" name="commantaire1">${commande.getCommantaire1()}</textarea>
                                            </div>
                            ...
                            <div class="form-group">
                                <div class="btn-group btn-sm" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" title="Modifier le produit" class="btn-sm btn btn-float btn-outline-primary btn-round btn-link-update hidden" name="idC" action="gestionCommandes?action=model&model=PropositionCommande&q=${q}&isNew=3&id=${numc}"><i class="fa fa-edit"></i></button>


                                    <a data-toggle="tooltips" title="Valider  la proposition" class="btn-sm btn btn-float btn-outline-success btn-round add_commande" href="gestionCommandes?action=model&model=PropositionCommande&q=${q}&isNew=1&id=${numc}">
