<%-- 
    Document   : entreeCaisse
    Created on : 18 avr. 2019, 10:21:51
...
<c:if test="${sessionScope.societe.getGestcaisse() == 1}">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Entrée en Caisse</h4>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="card-text">
                                    <form class="form" method="post" action="gestioncaisse?action=model&model=entreeAccount&q=${q}&isNew=1">
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="form-group col-lg-2 col-sm-12">
                                                    ...
                                                    <input type="number" value="" min="0" class="form-control-sm form-control round" required name="montant"/>
                                                </div>
                                                <div class="form-group col-lg-2 col-sm-12">
                                                ...
                                                <div class="form-control-sm form-group col-lg-2 col-sm-12">
                                                    <button type="submit" class="btn btn-primary round btn-sm btn_caisse" style="margin-top: 25px">
                                                        <i class="fa fa-download"></i> Effectuer
                                                    </button>
                                                </div>
                                            </div>
                                        </fieldset>
                                ...
                                <div class="form-group">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="button"  class="btn btn-float btn-outline-success btn-round btn-link-update"
                                                ...
                                                name="id" action="gestioncaisse?q=${q}&action=model&model=entreeAccount&isNew=2">
                                    ...
                                    <tbody>
                                        <c:if test="${not empty entrees }">
                                            ...
                                            <c:forEach items="${entrees}" var="cmd">
                                                <c:if test="${empty cmd.getLigneAccount()}">
                                                    <c:set var="total" value="${total+cmd.getAvance()}"></c:set>
                                                        <tr>
    ...
    <c:if test="${sessionScope.root=='EH2S' or 1==1}">
        <c:import url="/WEB-INF/composants/modal/voirEntree.jsp"/>
    </c:if>
</c:if>
