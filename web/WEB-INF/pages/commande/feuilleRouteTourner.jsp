<%-- 
    Document   : feuilleRouteTourner
    Created on : 8 mars 2019, 16:21:45
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien131}">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <p class="card-text">
                                    <form class="form feuille_route_tourner" novalidate method="post" action="gxwzy14iyf?q=${q}&action=model&model=TicketmodelByPeriode&isNew=${isNew}&iq=${iq}&periode=2">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="form-group col-lg-3 col-sm-12">
                                                    ...
                                                    <select style="width: 100%" required id="articles_categorie" class="select2-size-xs block form-control round" name="etat">
                                                        <c:forEach  items="${statutCommandes}"  var="etat">
                                                            <c:if test="${etat.getCode() == 201 or etat.getCode() == 200}">
                                                ...
                                                <div class="form-group col-lg-3 col-sm-12">
                                                    <label for="client">Tourner<span class="danger">*</span></label>
                                                        <select style="width: 100%" multiple="multiple" id="tourner" class="select2-size-xs block form-control round" name="tourner">
