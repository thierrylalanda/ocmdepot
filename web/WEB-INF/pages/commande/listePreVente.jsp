<%-- 
    Document   : listePreVente
    Created on : 20 avr. 2019, 17:37:13
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">LISTE DES PREVENTES</h4>
                                    ...
                                    <div class="form-group">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien105}">
                                                ...
                                                <button type="button" class="btn btn-float btn-outline-dark btn-round print_one_element_commande petit_format" 
                                    ...
                                    <table class="table table-dark table-striped table-bordered responsive dataex-colvis-restore">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${commandes}" var="all">
                                                <c:if test="${all.getEtatc().getCode()!=200 and all.getEtatc().getCode()!=300}">
