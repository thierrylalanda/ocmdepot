<%-- 
    Document   : mouvement
    Created on : 4 juin 2019, 09:57:04
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-center-dropdown">Mouvements Emballages</h4>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="card-text">
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-1 col-sm-12">
                                                ...
                                                <input type="number"  value="${inventaire.getQuantite()}" required step="0.01" class="form-control-sm form-control round" name="quantite"/>
                                            </div>
                                ...
                                <form class="form form_commentaire_inventaire hidden" id="" method="post" action="inventaire?q=${q}&action=model&model=inventaire&isNew=2&type=${type}&isInv=1">
                                    <fieldset>
                                        <div class="row">
                                ...
                                <table style="width: 100%" class="table table-dark table-striped table-bordered dataex-colvis-restore">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${inventaires}" var="cmd">
                                            ...
                                            <c:set var="total" value="${total + (cmd.getQtAvant()+cmd.getQuantite())}"></c:set>
                                                <tr>
                                        ...
                                        <td>${cmd.getQtAvant()+cmd.getQuantite()}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    <tfoot>
