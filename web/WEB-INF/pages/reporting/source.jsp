<%-- 
    Document   : source
    Created on : 18 oct. 2018, 15:47:19
    Author     : eh2s001
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien69}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Reporting Source</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    ...
                                                    <select  style="width: 100%" required id="xsmall-multiple" multiple="multiple" class="select2-size-xs block form-control round" name="entity">
                                                        <c:forEach items="${sources}" var="per">
