<%-- 
    Document   : region
    Created on : 24 oct. 2018, 13:46:39
    Author     : messi
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien65}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Reporting Region</h4>
