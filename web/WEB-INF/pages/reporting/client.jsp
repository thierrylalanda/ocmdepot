<%-- 
    Document   : client
    Created on : 18 oct. 2018, 15:44:36
    Author     : eh2s001
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien67}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Reporting Client</h4>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    ...
                                                    <select style="width: 100%" required id="region_reporting_client" class="select2-size-xs block form-control round" name="interval">
                                                        <option > </option>
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    <label for="personnel">Client
                                                        <span class="danger">*</span></label>
                                                    <select style="width: 100%" required id="client_reporting" class="select2-size-xs block form-control round" name="personnel">
