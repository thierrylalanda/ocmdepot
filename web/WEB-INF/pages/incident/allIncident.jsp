<%-- 
    Document   : allIncident
    Created on : 27 oct. 2018, 08:15:55
    Author     : messi
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien85}">
    <%
        Date now = new Date();
                                    ...
                                    <table class="table table-dark table-striped table-bordered responsive dataex-colvis-restore">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Priorite</th>
                                                <th>Statut</th>
                                                <th class="datec" pos="7">Date creation</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach items="${totalticket}" var="inc">
