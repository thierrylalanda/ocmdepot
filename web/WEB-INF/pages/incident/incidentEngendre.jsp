<%-- 
    Document   : incidentEngendre
    Created on : 18 oct. 2018, 13:30:10
    Author     : eh2s001
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien60}">
    <%
        Date now = new Date();
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Incidents Engendrés</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="form-group">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien91}">
                                                ...
                                                <button title="Modifier l'incident" type="button" class="btn btn-float btn-outline-primary btn-round btn-link-update" name="id" action="ticket?q=incident/nouvelIncident&action=model&model=saveTicket&isNew=2"><i class="fa fa-edit"></i></button>
                                                </c:if>
                                                <c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien93}">
                                                <button  title="Supprimer l'incident" type="button" class="btn btn-float btn-outline-danger btn-round btn-link-delete" name="id" action="ticket?q=${q}&action=model&model=saveTicket&isNew=5"><i class="fa fa-trash"></i></button>
                                                </c:if>
                                    ...
                                    <table class="table table-dark table-striped table-bordered responsive dataex-colvis-restore">
                                        ...
                                        <tbody>
                                            <c:forEach items="${ticketEncours}" var="inc">
