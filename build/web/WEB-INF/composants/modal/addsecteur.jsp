...
<c:if test="${secteur != null}">
    ...
    <c:set var="id" value="&secteur=${secteur.getId()}"></c:set>
</c:if>
<c:if test="${secteur == null}">
    <c:set var="isnew" value="${0}"></c:set>
</c:if>
<div class="modal fade in text-left <c:if test="${secteur != null}">autoshow</c:if>" data-backdrop="static" id="bootstrap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
     aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h3 class="modal-title" id="myModalLabel35">Ajouter un Secteur</h3>
                <c:if test="${secteur == null}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select style="width: 100%"  id="societe_region"  class=" select2-size-xs block form-control round required district_by_region"  name="region">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select style="width: 100%" required id="region_district" class="select2-size-xs block form-control round region_district" name="district">
                                         <c:forEach items="${districts}" var="reg">
                                            <option <c:if test="${reg.getId()==secteur.getDistrictid().getId()}">selected</c:if> value="${reg.getId()}"> ${reg.getName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="${secteur.getName()}"  class="form-control-sm round form-control" required id="firstName" name="nom">
                                </div>
                            </div>
