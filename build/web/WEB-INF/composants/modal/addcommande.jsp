<%-- 
    ...
    Created on : 29 nov. 2018, 17:33:28
    Author     : messi01
--%>
     ...
     aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-body">
                ...
                <form class="form" novalidate method="post" action="gestionCommandes?action=model&model=PasserCommandes&q=${q}&isNew=${isnew}${id}">
                    <!-- Step 1 -->
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2 col-sm-12">
                                <label for="categorie_article">Livraison
                                    <span class="danger">*</span></label>
                                    <input type="text" <c:if test="${sessionScope.njr != null}">disabled value="${sessionScope.njr}"</c:if> class="form-control-sm form-control round singledate" required name="njr"/>
                                </div>
                            </div>
                        </fieldset>    
                        <fieldset>
