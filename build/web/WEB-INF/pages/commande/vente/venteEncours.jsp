<%-- 
    Document   : venteEncours
    Created on : 21 avr. 2019, 16:55:18
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Ventes Encours</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <button title="Modifier la vente" class="btn-sm btn btn-float btn-outline-primary btn-round btn-link-update"
                                            data-toggle="tooltips" name="id" action="gestionCommandes?action=model&model=vente&q=commande/vente/editVente&isNew=0">
                                    ...
                                    <button type="button" class="btn btn-float btn-outline-danger btn-round btn-link-delete" name="id" action="gestionCommandes?q=${q}&action=model&model=PasserCommandes&isNew=11"><i class="fa fa-trash"></i></button>
