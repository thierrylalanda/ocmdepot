<%-- 
    ...
    Created on : 4 juin 2019, 09:59:44
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Historique Mouvement Emballages </h4>
                                ...
                                <div style="overflow-x: scroll">
                                    <table style="width: 100%" class="table table-dark table-striped table-bordered dataex-colvis-restore">
                                        ...
                                        <c:if test="${empty inventaires }">
                                            <c:forEach items="${sessionScope.utilisateur.getSociete().getLigneInventaireList()}" var="cmd">
                                                <c:if test="${cmd.getType()==type}">
                                                    <c:if test="${cmd.getIsInv()==1}">
                                                        <tr>
                                                            <td><option selected  class="hidden">${cmd.getId()}</option> </td>
