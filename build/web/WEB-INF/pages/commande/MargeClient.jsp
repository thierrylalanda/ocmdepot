<%-- 
    Document   : MargeClient
    Created on : 23 janv. 2019, 12:18:46
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Ristourne Clients</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">
                                        <form method="post" action="gestionCommandes?q=${q}&action=model&model=HistoriqueCommande&isNew=5" class="" novalidate>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 marge_categorie">
                                                        <div class="form-group">
                                                            ...
                                                            <select style="width: 100%" id="" class="select2-size-xs block form-control round" name="client">

                                                                <c:forEach items="${clients}" var="cat">
                                        ...
                                        <br>
                                        <table class="table table-dark table-striped table-bordered responsive marge_table">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach items="${commandes}" var="all">
                                                    ...
                                                    <c:set var="qteL" value="${qteL + (all.getMargeFournisseur())}"></c:set>
                                                        <tr >
                                                            <td style="cursor: pointer" data-toggle="tooltip" title="${title}">${i}</td>  
