<%-- 
    Document   : allDetteFournisseur
    Created on : 21 mai 2019, 15:58:33
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Dettes Fournisseurs</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="button" class="btn btn-float btn-outline-primary btn-round btn-link-update" name="id" action="gestioncaisse?action=model&model=addBonCommande&q=commande/caisse/resolveBon&isNew=2&forpaiement=0"><i class="fa fa-money"></i></button>
