<%-- 
    Document   : allAccount
    Created on : 7 avr. 2019, 13:35:05
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Liste Facture Client</h4>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="card-text">
                                    <form method="post" action="historiques?q=${q}&action=model&model=historiqueCaisse&isNew=4" class="" novalidate>
                                ...
                                <div class="form-group">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="button" data-toggle='tooltips' title="Annuler une facture " class="btn btn-float btn-outline-danger btn-round btn-link-delete-facture" name="id" action="gestioncaisse?q=${q}&action=model&model=entreeAccount&isNew=4"><i class="fa fa-trash"></i></button>
                                        <button type="button" class="btn btn-float btn-outline-primary btn-round print_one_element_commande_caisse petit_format" 
                                                data-toggle='tooltips' title="Imprimer une commande sous petit format"
                                                name="id" action="ticket?q=${q}&action=model&model=traitementTicket&isNew=2&fromcaisse=yes"><i class="fa fa-print"></i></button>
                                        <button type="button" class="btn btn-float btn-outline-dark btn-round print_one_element_commande_caisse" 
