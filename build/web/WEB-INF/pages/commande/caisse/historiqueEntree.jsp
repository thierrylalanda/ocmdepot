<%-- 
    Document   : historiqueEntree
    Created on : 21 mai 2019, 13:47:09
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="card-text">
                                    <form class="form" method="post" action="historiques?action=model&model=historiqueCaisse&q=${q}&isNew=6">
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-md-2">
