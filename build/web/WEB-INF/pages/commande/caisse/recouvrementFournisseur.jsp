<%-- 
    Document   : recouvrementFournisseur
    Created on : 22 mai 2019, 16:51:18
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Recouvrement Dette Fournisseur</h4>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="card-text">
                                    <form method="post" action="historiques?q=${q}&action=model&model=recouvrement&isNew=1" class="" novalidate>
                                    ...
                                    <tbody>
                                        <c:if test="${not empty recouvrements }">
                                            ...
                                            <c:forEach items="${recouvrements}" var="cmd">
                                                ...
                                                <c:set var="totalMT" value="${totalMT+cmd.getMontant()}"></c:set>
                                                <c:set var="totalAV" value="${totalAV+(cmd.getMontant()-cmd.getMontantRestant())}"></c:set>
                                                    <tr>
                                                        <td><option selected  class="hidden">${cmd.getId()}</option> </td>
                                            <td>${cmd.getId()}</td>
                                            <td>${cmd.getLigneSortie().getFournisseur().getNom()}</td>
