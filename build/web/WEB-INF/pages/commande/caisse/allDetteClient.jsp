<%-- 
    Document   : allDetteClient
    Created on : 21 mai 2019, 15:40:11
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Dette Client</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="button" data-toggle='tooltips' title="Paiement dette " class="btn btn-float btn-outline-primary btn-round btn-link-update" name="id" action="gestioncaisse?action=model&model=addAccount&q=commande/caisse/resolveAccount&isNew=2"><i class="fa fa-money"></i></button>
