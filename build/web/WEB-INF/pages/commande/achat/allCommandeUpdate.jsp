<%-- 
    Document   : allCommandeUpdate
    Created on : 28 mai 2019, 14:09:48
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button title="Réceptionner le bon de commande" class="btn-sm btn btn-float btn-outline-primary btn-round btn-link-update"
                                                data-toggle="tooltips" name="id" action="gestionachat?action=model&model=bonAchat&q=commande/achat/updateBon&isNew=1">
