<%-- 
    Document   : IncidentNonResolu
    Created on : 29 oct. 2018, 16:48:10
    Author     : messi
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien82}">
    <%
        Date now = new Date();
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    ...
                                    <table class="table table-dark table-striped table-bordered responsive dataex-colvis-restore">
                                        ...
                                        <tbody>
                                            <c:forEach items="${ticketNonResolutcli}" var="inc">
