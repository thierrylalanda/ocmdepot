<%-- 
    Document   : resoluIncident
    Created on : 27 oct. 2018, 08:14:29
    Author     : messi
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien81}">
    <%
        Date now = new Date();
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    ...
                                    <table class="table table-dark table-striped table-bordered responsive dataex-colvis-restore">
                                        ...
                                        <tbody>
                                            <c:forEach items="${ticketresolutcli}" var="inc">
