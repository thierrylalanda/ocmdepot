<%-- 
    Document   : reporting
    Created on : 18 oct. 2018, 13:36:41
    Author     : eh2s001
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien66}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Reporting Personnel</h4>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    ...
                                                    <select style="width: 100%" required id="region_reporting_personnel" class="select2-size-xs block form-control round" name="">
                                                        <option > </option>
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    ...
                                                    <select style="width: 100%" required id="personnel_reporting" class="select2-size-xs block form-control round" name="personnel">
                                        ...
                                        <tbody>
                                            <c:forEach items="${incidentsEntity}" var="inc">
                                                <tr>
                                                    ...
                                                    <td>${inc.getResponsable().getFirstname()}</td>    
