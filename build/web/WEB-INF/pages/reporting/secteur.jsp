<%-- 
    Document   : secteur
    Created on : 25 oct. 2018, 10:12:03
    Author     : eh2s001
--%>
...
<!DOCTYPE html>
<c:if test="${sessionScope.root=='EH2S' or not empty sessionScope.lien71}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Reporting Secteur</h4>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    ...
                                                    <select style="width: 100%" required id="region_reporting_secteur" class="select2-size-xs block form-control round" name="personnel">
                                                        <option > </option>
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    <label for="personnel">District
                                                        <span class="danger">*</span></label>
                                                    <select style="width: 100%" required id="district_reporting_secteur" class="select2-size-xs block form-control round" name="personnel">
                                                ...
                                                <div class="form-group col-lg-3 col-md-12 mb-2">
                                                    <label for="personnel">Secteur
                                                        <span class="danger">*</span></label>
                                                    <select style="width: 100%" required id="secteur_reporting" class="select2-size-xs block form-control round" name="personnel">
