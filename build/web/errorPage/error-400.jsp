<%-- 
    Document   : error-400
    Created on : 15 oct. 2018, 16:20:42
    Author     : eh2s001
--%>
...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="StackAdmin/app-assets/css/pages/error.css">
        <!-- END Page Level CSS-->
        <!-- BEGIN Custom CSS-->
        <link rel="stylesheet" type="text/css" href="StackAdmin/assets/css/style.css">
        <!-- END Custom CSS-->
    </head>
                                ...
                                <div class="card-content">
                                    <div class="row py-2">
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <a href="javascript:history.go(-1)" class="btn btn-primary btn-block"><i class="ft-arrow-down-left"></i> Page précédente</a>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-6">
                                            <a href="javascript:history.go(-1)" class="btn btn-danger btn-block"><i class="ft-search"></i>  Advanced search</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer bg-transparent">
                                    <div class="row">
                                        <p class="text-muted text-center col-12 py-1">Nous suivre suivre</p>
                                        <div class="col-12 text-center">
                                            <a href="#" class="btn btn-social-icon mr-1 mb-1 btn-outline-facebook">
                                                <span class="fa fa-facebook"></span>
                                            </a>
                                            <a href="mailto:eh2s.sarl@gmail.com" class="btn btn-social-icon mr-1 mb-1 btn-outline-google">
                                        ...
                                        <p class="text-muted text-center col-12 py-1">© <script> document.write(new Date().getFullYear());</script> <a href="#"></a>OCM by <a href="https://www.eh2s.com" target="_blank">EH2S</a></p>
