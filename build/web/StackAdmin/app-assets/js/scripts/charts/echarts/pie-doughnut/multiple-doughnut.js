        ...
        function (ec) {
            ...
            chartOptions = {
                ...
                legend: {
                    x: 'center',
                    y: '56%',
                    data: ['GoogleMaps qdmkjpoigngfifndiydfafaefae', 'Facebook', 'Youtube', 'Google+', 'Weixin', 'Twitter', 'Skype', 'Messenger', 'Whatsapp', 'Instagram']
                },
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            {name: 'GoogleMaps qdmkjpoigngfifndiydfafaefae', value: 54,itemStyle: labelTop}
                        ]
                    },
                    {
                        type: 'pie',
