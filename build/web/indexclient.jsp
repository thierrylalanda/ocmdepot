<%-- 
    ...
    Created on : 26 oct. 2018, 14:58:38
    Author     : eh2s001
--%>
                                ...
                                <div class="card border-grey border-lighten-3 m-0">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2">
                                            <span>Connexion à votre compte client</span><br>

                                        </p>
                                        <div class="card-body pt-0">
                                            <form class="form-horizontal" action="getconnexionClient?q=client/nouvelIncident" method="post">
                                                <fieldset class="form-group floating-label-form-group">
                                                    <label for="user-name">Code </label>
                                                    <input type="text" class="form-control" required id="user-name" name="code" placeholder="Code client">
                                                </fieldset>
                                                 <fieldset class="form-group floating-label-form-group">
                                                    <label for="user-name">Mot de passe </label>
                                                    <input type="password" class="form-control" required id="user-name" name="password" placeholder="Mot de passe">
                                                </fieldset>
                                                <div class="form-group row">
                                                    <div class="col-md-6 col-12 text-center text-sm-left">

                                                    </div>
                                                    <div class="col-md-6 col-12 float-sm-left text-center text-sm-right"><a href="getconnexionClient?getCreationclient=145uydcudkq" class="card-link">créer un compte</a></div>
                                                </div>
                                        ...
                                        <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1">
                                            <span><a href="index.jsp" class="btn btn-outline-danger btn-block"><i class="ft-user"></i> Utilisateur</a></span>
                                        </p>
                                    </div>
                                </div>
